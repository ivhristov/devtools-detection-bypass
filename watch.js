!(function (b) {
    (function () {
        ...
        function n(e, t) {
            var n,
                i,
                o = e.length;
            if (o && t) for (n = t.toLowerCase(), i = 0; i < o; ++i) if (n === e[i].toLowerCase()) return !0;
            return !1;
        }
        function e(e) {
        ...
        for (i in d.props)
            if (u.call(d.props, i)) {
                for (r = d.props[i], c = (r = S(r) ? r : [r]).length, s = 0; s < c; ++s) 0 <= (l = (a = r[s]).indexOf("[VER]")) && (a = a.substring(0, l) + "([\\w._\\+]+)" + a.substring(l + 5)), (r[s] = new RegExp(a, "i"));
                d.props[i] = r;
            }
        return (
            e(d.oss),
            ...
            (T.getVersionStr = function (e, t) {
                ...
                if (u.call(a, e)) for (o = (n = a[e]).length, i = 0; i < o; ++i) if (null !== (r = n[i].exec(t))) return r[1];
                return null;
            }),
            ...
            (T.prepareVersionNo = function (e) {
                ...
                return 1 === t.length && (e = t[0]), 1 < t.length && ((e = t[0] + "."), t.shift(), (e += t.join(""))), Number(e);
            }),
            ...
            (T.mobileGrade = function (e) {
                ...
                return (e.os("iOS") && 4.3 <= e.version("iPad")) ||
                    ...
                    (e.is("Skyfire") && 4.1 <= e.version("Skyfire") && e.is("AndroidOS") && 2.3 <= e.version("Android")) ||
                    (e.is("Opera") && 11 < e.version("Opera Mobi") && e.is("AndroidOS")) ||
                    e.is("MeeGoOS") ||
                    e.is("Tizen") ||
                    (e.is("Dolfin") && 2 <= e.version("Bada")) ||
                    ((e.is("UC Browser") || e.is("Dolfin")) && 2.3 <= e.version("Android")) ||
                    e.match("Kindle Fire") ||
                    ...
                    : (e.os("iOS") && e.version("iPad") < 4.3) ||
                      ...
                      (e.is("Blackberry") && 5 <= e.version("BlackBerry") && e.version("BlackBerry") < 6) ||
                      (5 <= e.version("Opera Mini") && e.version("Opera Mini") <= 6.5 && (2.3 <= e.version("Android") || e.is("iOS"))) ||
            ...
            (o.prototype = {
                ...
                userAgent: function () {
                    return this._cache.userAgent === b && (this._cache.userAgent = T.findMatch(T.mobileDetectRules.uas, this.ua)), this._cache.userAgent;
                },
                userAgents: function () {
                    return this._cache.userAgents === b && (this._cache.userAgents = T.findMatches(T.mobileDetectRules.uas, this.ua)), this._cache.userAgents;
                },
                os: function () {
                    return this._cache.os === b && (this._cache.os = T.detectOS(this.ua)), this._cache.os;
                },
                version: function (e) {
                ...
                is: function (e) {
                    return n(this.userAgents(), e) || t(e, this.os()) || t(e, this.phone()) || t(e, this.tablet()) || n(T.findMatches(T.mobileDetectRules.utils, this.ua), e);
                },
                match: function (e) {
                    return (e = e instanceof RegExp ? e : new RegExp(e, "i")).test(this.ua);
                },
                isPhoneSized: function (e) {
                    return o.isPhoneSized(e || this.maxPhoneWidth);
                },
                mobileGrade: function () {
                    return this._cache.grade === b && (this._cache.grade = T.mobileGrade(this)), this._cache.grade;
                },
            }),
    ...
    !(function (e) {
        ...
        "Promise" in n ? n.Promise.prototype.finally || (n.Promise.prototype.finally = e) : (n.Promise = r);
    }),
    !(function (e, t) {
            ...
            (n = [
                function (e, t, n) {
                    ...
                    !function (e) {
                        (t.c = function () {
                            ...
                            (t.b = function (e) {
                                for (var t = (e = void 0 === e ? {} : e).includes, e = e.excludes, e = void 0 === e ? [] : e, n = !1, i = !1, o = 0, r = void 0 === t ? [] : t; o < r.length; o++)
                                    if (!0 === r[o]) {
                                        n = !0;
                                        break;
                                    }
                ...
                function (e, t, n) {
                    ...
                    var i,
                        ...
                        n = n(0),
                        n = Object(n.a)(),
                        o = "InstallTrigger" in ((null == n ? void 0 : n.window) || {}) || /firefox/i.test(t.b),
                        r = /trident/i.test(t.b) || /msie/i.test(t.b),
                        a = /edge/i.test(t.b),
                        s = /webkit/i.test(t.b) && !a,
                        c = /IqiyiApp/.test(t.b),
                        l = void 0 !== (null == (i = null == n ? void 0 : n.window) ? void 0 : i.chrome) || /chrome/i.test(t.b) || /CriOS/i.test(t.b),
                        T = "[object SafariRemoteNotification]" === ((null == (n = null == (i = null == n ? void 0 : n.window) ? void 0 : i.safari) ? void 0 : n.pushNotification) || !1).toString() || (/safari/i.test(t.b) && !l);
                },
                function (e, t, n) {
                    "use strict";
                    n.d(t, "b", function () {
                ...
                function (e, t, n) {
                    ...
                    (t.a = function () {
                        ...
                        return null != i && i.document ? (e = i.document).createElement.apply(e, t) : {};
                    }),
                        n.d(t, "b", function () {
                            return o;
                        });
                    var t = n(0),
                        i = Object(t.a)(),
                        o = (null == (n = null == i ? void 0 : i.navigator) ? void 0 : n.userAgent) || "xxxxx";
                },
                function (e, t, n) {
                    "use strict";
                    ...
                    var i = n(7),
                        ...
                        u =
                            ...
                            new i.a({ checkers: [o.erudaChecker, o.elementIdChecker, o.regToStringChecker, o.functionToStringChecker, o.depRegToStringChecker, o.dateToStringChecker, o.performanceChecker, o.debuggerChecker] }));
                    t.default = u;
                },
                function (e, t, n) {
                    "use strict";
                    ...
                    for (var i = {}, o = 0, r = (n(3).b || "").match(/\w+\/(\d|\.)+(\s|$)/gi) || []; o < r.length; o++) {
                        var a = r[o].split("/"),
                            s = a[0],
                            a = a[1];
                        i[s] = a;
                            ...
                            (r.prototype._detectLoop = function () {
                                return i(this, void 0, void 0, function () {
                                    ...
                                    return s(this, function (e) {
                                        switch (e.label) {
                                            case 0:
                                                (t = !1), (n = ""), (i = 0), (o = this._checkers), (e.label = 1);
                                            case 1:
                                                return i < o.length ? [4, (r = o[i]).isEnable()] : [3, 6];
                                            case 2:
                                                return e.sent() ? ((n = r.name), [4, r.isOpen()]) : [3, 4];
                                            case 3:
                                                (t = e.sent()), (e.label = 4);
                                            case 4:
                                                if (t) return [3, 6];
                            ...
                            }),
                            {
                                ...
                                isOpen: function () {
                                    return a(this, void 0, void 0, function () {
                                        return s(this, function (e) {
                                            return (l = !1), Object(o.c)({ dep: c }), Object(o.a)(), [2, l];
                                        });
                                    });
                                },
                                isEnable: function () {
                                    return a(this, void 0, void 0, function () {
                                        return s(this, function (e) {
                                            return [2, Object(r.b)({ includes: [!0], excludes: [i.c, i.d] })];
                                        });
                                    });
                                },
                            });
                    ...
                    void 0 !==
                        (t =
                            ...
                            typeof (i = function () {
                                ...
                                function o(e, t) {
                                    [e, t].forEach(d);
                                    for (var n = u(e), i = u(t), o = 0; o < Math.max(n.length - 1, i.length - 1); o++) {
                                    ...
                                    if (s && c) {
                                        ...
                                        for (o = 0; o < Math.max(l.length, T.length); o++) {
                                            if (void 0 === l[o] || ("string" == typeof T[o] && "number" == typeof l[o])) return -1;
                                            if (void 0 === T[o] || ("string" == typeof l[o] && "number" == typeof T[o])) return 1;
                                            if (l[o] > T[o]) return 1;
                                            if (T[o] > l[o]) return -1;
                                        }
                        ...
                        T =
                            ...
                            }),
                            {
                                ...
                                isEnable: function () {
                                    return a(this, void 0, void 0, function () {
                                        return s(this, function (e) {
                                            return [2, Object(r.b)({ includes: [!0], excludes: [i.d, i.b, i.c] })];
                                        });
                                    });
                                },
                            });
                                ...
                                isOpen: function () {
                                    return s(this, void 0, void 0, function () {
                                        return c(this, function (e) {
                                            return (T = 0), Object(o.b)(l), Object(o.a)(), [2, 2 === T];
                                        });
                                    });
                                },
                                isEnable: function () {
                                    return s(this, void 0, void 0, function () {
                                        return c(this, function (e) {
                                            return [2, Object(a.b)({ includes: [!0], excludes: [i.e, i.c, (r.b || r.c) && i.a] })];
                                        });
                                    });
                                },
                            });
                        ...
                        T =
                            ...
                            }),
                            {
                                ...
                                isEnable: function () {
                                    return a(this, void 0, void 0, function () {
                                        return s(this, function (e) {
                                            return [2, Object(r.b)({ includes: [!0], excludes: [o.g] })];
                                        });
                                    });
                                },
                            });
                            ...
                            isOpen: function () {
                                return o(this, void 0, void 0, function () {
                                    ...
                                    return r(this, function (e) {
                                        return (t = Object(i.c)()), function () {}.constructor("debugger")(), [2, 100 < Object(i.c)() - t];
                                    });
                                });
                            },
                            isEnable: function () {
                        ...
                        u =
                            ...
                            }),
                            {
                                ...
                                isEnable: function () {
                                    return s(this, void 0, void 0, function () {
                                        return c(this, function (e) {
                                            return [2, Object(r.b)({ includes: [i.a], excludes: [(a.isIpad || a.isIphone) && i.a] })];
                                        });
                                    });
                                },
                            });
                            ...
                            isOpen: function () {
                                ...
                                return i(this, void 0, void 0, function () {
                                    return o(this, function (e) {
                                        return "undefined" != typeof eruda ? [2, !0 === (null == (t = null === eruda || void 0 === eruda ? void 0 : eruda._devTools) ? void 0 : t._isShow)] : [2, !1];
                                    });
                                });
                            },
                            isEnable: function () {
        ...
        function i(e) {
            var t;
            return (o[e] || ((t = o[e] = { i: e, l: !1, exports: {} }), n[e].call(t.exports, t, t.exports, i), (t.l = !0), t)).exports;
        }
        var n, o;
    });
...
function getReplies(t, n = null) {
    $.get("/ajax/comment/replies/" + t, function (e) {
        $("#replies-" + t).html(e.html), $("#replies-" + t).slideToggle(200), n && ($(`#cm-${t} .cm-btn-show-rep`).addClass("active"), $("#cm-" + n).addClass("comment-focus"), $(window).scrollTo($("#cm-" + n).prev(), { duration: 300 }));
    });
}
function getCommentWidget(e, t = !1) {
    var n = `/ajax/comment/widget/${movieId}?episodeId=${epId}&sort=` + cmSort,
        i =
            (currentUrl.search && firstLoad && (i = new URLSearchParams(currentUrl.search)).get("c_id") && i.get("c_type") && ((e = i.get("c_type")), (n = n + "&cId=" + i.get("c_id")), (t = !0)),
            (n = n + "&type=" + e),
    ...
    ((i && !commentLoaded) || t) &&
        ...
        $.get(n, function (e) {
            var t;
            $("#content-comments").html(e.html), e.gotoId && ($(window).scrollTo(".block_area-comment", { duration: 300 }), 0 < (t = $("#cm-" + e.gotoId)).length ? t.addClass("comment-focus") : getReplies(e.cParentId, e.gotoId));
        }));
}
$(document).on("click", "#cm-view-more", function () {
    if (!commentLoading) {
        ...
        var e = $(this).data("page"),
            ...
            e = `/ajax/comment/list/${movieId}?episodeId=${epId}&page=${e}&sort=${cmSort}&type=` + t;
        $.get(e, function (e) {
            (commentLoading = !1), e && e.status && (0 < e.nextPage ? n.data("page", e.nextPage) : n.remove(), $(".cw_list").append(e.html));
        });
    }
}),
    $(document).on("click", ".cm-report", function () {
        ...
        checkLogin() &&
            ...
            $.post("/ajax/comment/report", { id: e, type: t }, function (e) {
                (commentLoading = !1), e.status ? toastr.success(e.msg, "", { timeOut: 6e3 }) : toastr.error(e.msg, "", { timeOut: 6e3 });
            }));
    }),
    $(document).on("click", ".cm-sort", function () {
        (cmSort = $(this).data("value")), getCommentWidget($(".cm-by.active").data("value"), !0);
    }),
    $(document).on("click", ".cm-by", function () {
        getCommentWidget($(this).data("value"), !0);
    }),
    ...
    $(document).on("click", ".cm-btn-show-rep", function () {
        var e = $(this).data("id");
        $(this).toggleClass("active"), $(this).hasClass("active") ? getReplies(e) : $("#replies-" + e).slideToggle(200);
    }),
    ...
    $(document).on("click", ".cm-action", function () {
        ...
        $.post("/ajax/comment/update", { id: n, action: t }, function (e) {
            e.status ? ("hide" === t && $("#cm-" + n).remove(), toastr.success(e.msg, "", { timeOut: 6e3 })) : toastr.error(e.msg, "", { timeOut: 6e3 });
        });
    }),
    ...
    $(document).on("click", ".cm-btn-vote", function () {
        ...
        checkLogin() &&
            ...
            (n = e.data("id")),
            0 < (o = $(".cm-btn-vote[data-id=" + n + "].active")).length && parseInt(o.data("type")) !== t && (o.removeClass("active"), 0 < (i = parseInt(o.find(".value").text()))) && ((i -= 1), o.find(".value").text(0 < i ? i : "")),
            e.toggleClass("active"),
            (o = 0 < (o = parseInt(e.find(".value").text())) ? (e.hasClass("active") ? o + 1 : o - 1) : 1),
            e.find(".value").text(0 < o ? o : ""),
            $.post("/ajax/comment/vote", { id: n, type: t }, function (e) {
                (commentLoading = !1), e.status || toastr.error(e.msg, "", { timeOut: 6e3 });
            }));
    }),
    $(document).on("submit", ".comment-form", function (e) {
        if ((e.preventDefault(), !commentLoading)) {
            ...
            t.push({ name: "movie_id", value: movieId }),
                t.push({ name: "is_spoil", value: $(".btn-spoil").hasClass("active") ? 1 : 0 }),
                grecaptcha.execute(recaptchaSiteKey, { action: "add_comment" }).then(function (e) {
                            ...
                            (commentLoading = !1),
                                ...
                                e && e.status
                                    ? (0 < parseInt(e.parentId)
                                          ? (0 < (t = $("#block-reply-" + e.parentId)).length ? t.html(e.html) : $("#cm-" + e.parentId).append(`<div class="replies" id="block-reply-${e.parentId}">${e.html}</div>`),
                                            $(`#cm-${e.parentId} .cm-btn-show-rep`).addClass("active"),
                                            $("#replies-" + e.parentId).slideToggle(100),
                                            $("#reply-" + e.parentId).slideToggle(100))
                                          : ($("#df-cm-buttons").slideUp(100), $(".list-comment .cw_list").html(e.html)),
                                      i[0].reset(),
    ...
    0 < $("#content-comments").length &&
        window.addEventListener("scroll", function () {
            isInViewport(document.getElementById("content-comments")) && getCommentWidget("episode");
        });
...
var intervalContinueWatchLog = null;
const keyLsCurrentServer = "v2.5_currentServer";
...
function continueWatchLog() {
    0 < playerCurrentTime &&
        ...
        $.post("/ajax/continue-watch/log", { movie_id: movieId, episode_id: epId, episode_number: epNumber, time: Math.round(playerCurrentTime), percent: Math.round(playerCurrentPercent), duration: Math.round(playerDuration) }, function (
            e
        ) {}));
}
function initContinueWatchingLog() {
    intervalContinueWatchLog && clearInterval(intervalContinueWatchLog),
        (intervalContinueWatchLog = setInterval(function () {
            isLoggedIn && checkedLogin ? continueWatchLog() : clearInterval(intervalContinueWatchLog);
        }, 1e4));
}
$(document).ready(function () {
    var e;
    0 < $(".schedule-alert").length && ((e = new Date($("#schedule-date").data("value").split(" ").join("T") + "Z")), $("#schedule-date").text(e.toLocaleString("en-US"))),
        countViewMovie(),
        $.get("/ajax/v2/episode/list/" + movieId, function (e) {
            ...
            e &&
                ...
                (0 < (e = document.querySelectorAll('.ep-item[data-id="' + urlGetParamByName().ep + '"]')).length
                    ? e[0]
                    : continueWatch
                    ? 0 < (e = document.querySelectorAll('.ep-item[data-id="' + continueWatch.episode_id + '"]')).length
                        ? e[0]
                        : $(".ss-list").first().find(".ep-item").first()
                    : ((e = localStorage.getItem("watching." + movieId)), (t = document.querySelectorAll('.ep-item[data-id="' + e + '"]')), e && 0 < t.length ? t[0] : $(".ss-list").first().find(".ep-item").first())
                ).click(),
                0 < $(".ep-page-item").length ? $(".ep-page-item[data-page=" + $(".ep-item.active").parent().data("page") + "]").click() : $("#episodes-page-" + $(".ep-item.active").parent().data("page")).show());
        }),
        $(".btn-comment-tab").click(function () {
            $(".btn-comment-tab").removeClass("active"), $(this).addClass("active");
        }),
        $(".btn-watch2gether").click(function (e) {
            e.preventDefault(), checkLogin() && (window.location.href = $(this).attr("href"));
        }),
...
function getSources(e) {
    $("#source-guide").empty(),
        $.get("/ajax/v2/episode/sources?id=" + e, function (e) {
            ...
            $("#embed-loading").hide(),
                e &&
                    (e.htmlGuide && ($("#content-guide").removeClass("only-one"), $("#source-guide").html(e.htmlGuide)), "" !== e.link) &&
                    ((t = e.link),
                    0 <= [1, 4].indexOf(parseInt(e.server)) &&
                        ((t += "&autoPlay=" + userSettings.auto_play + "&oa=" + (userSettings.play_original_audio || 0) + "&asi=" + userSettings.auto_skip_intro), continueWatch) &&
                        parseInt($(".ep-item.active").data("id")) === continueWatch.episode_id &&
...
eventer(messageEvent, function (e) {
    var t,
        ...
        i = e.data || e.message;
    try {
        "vidcloud" === (i = JSON.parse(i)).channel &&
            ("complete" === i.event && 1 === parseInt(userSettings.auto_next) && nextEpisode(), "time" === i.event && ((playerCurrentTime = i.time), (playerCurrentPercent = i.percent), (playerDuration = i.duration)), "error" === i.event) &&
            0 < (t = $(".server-item .btn.active").parent().next()).length &&
            ($(".server-item .btn").removeClass("active"),
            t.find(".btn").addClass("active"),
            (n = t.data("id")),
            "undefined" != typeof grecaptcha
                ? grecaptcha.execute(recaptchaSiteKey, { action: "get_sources" }).then(function (e) {
                      getSources(n, e);
                  })
                : getSources(n, ""));
    } catch (e) {}
    ...
    $(document).on("click", ".player-time", function () {
        ...
        $(window).scrollTo(0, { duration: 200 }), document.getElementById("iframe-embed").contentWindow.postMessage(JSON.stringify({ event: "seek", time: e }), "*");
    }),
    ...
    $(document).on("click", ".ep-item", function (e) {
        e.preventDefault(),
            ...
            (0 < $(".ss-list-min").length ? $(".ss-list.active") : $(".ss-list")).scrollTo(`.ep-item[data-id=${epId}]`, { duration: 300 });
        var e = $(this).next(),
            t = (getCommentWidget("episode"), JSON.parse($("#syncData").text().trim()));
        (t.episode = $(this).data("number")),
            0 < e.length ? (t.next_episode_url = t.series_url + "?ep=" + e.data("id")) : (t.next_episode_url = ""),
            $("#syncData").text(JSON.stringify(t)),
            localStorage.setItem("watching." + movieId, epId),
            firstLoad && currentUrl.search
                ? ((firstLoad = !1), history.pushState({}, "", window.location.origin + window.location.pathname + currentUrl.search))
            ...
            $.get("/ajax/v2/episode/servers?episodeId=" + epId, function (e) {
                ...
                e &&
                    ...
                    $("#embed-loading").hide(),
                    (e = localStorage.getItem("currentSource")),
                    (e = (t = urlGetParamByName().source) ? t : e) && 0 < $(".servers-" + e).length
                        ? ((t = localStorage.getItem(keyLsCurrentServer)), (n = $(".servers-" + e + " .server-item[data-server-id=" + t + "]")), (t && 0 < n.length ? n : $(".servers-" + e + " .server-item").first()).click())
                        : 1 === parseInt(userSettings.enable_dub) && (0 < $(".servers-mixed").length || 0 < $(".servers-dub").length)
                        ? 0 < $(".servers-mixed").length
                            ? $(".servers-mixed .server-item").first().click()
                            : 0 < $(".servers-dub").length && $(".servers-dub .server-item").first().click()
                        : (0 < $(".servers-sub").length ? $(".servers-sub .server-item") : $(".server-item")).first().click());
            });
    }),
